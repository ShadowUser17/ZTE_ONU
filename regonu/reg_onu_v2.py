...
try:
    ...
    #
    onu_vlans = None
    if args.onu_mode == 'a': onu_vlans = args.onu_pvid
    elif args.onu_mode == 't': onu_vlans = args.onu_tags
    elif args.onu_mode == 'h':
        #
        if not args.onu_tags: onu_vlans = args.onu_pvid
        elif args.onu_pvid: onu_vlans = (args.onu_pvid + ',' + args.onu_tags) 
    #
